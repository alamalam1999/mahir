...
class MenusTableSeeder extends Seeder
{
    ...
    */
    ...
    { 
        ...
        $this->insertTitle('user,admin', 'Mahir Accounting');
        $this->insertLink('user,admin', 'Data Data', '/data-data', 'fas fa-file-alt');
        $this->insertLink('user,admin', 'Buku Besar', '/buku-besar', 'fas fa-solid fa-book');
        $this->insertLink('user,admin', 'Penjualan', '/penjualan', 'fas fa-external-link-square-alt');
        $this->insertLink('user,admin', 'Pembelian', '/pembelian', 'fas fa-database');
        $this->insertLink('user,admin', 'Kas & Bank', '/kas-bank', 'fas fa-credit-card');
        $this->insertLink('user,admin', 'Persediaan', '/persediaan', 'fas fa-box-open');
        $this->insertLink('user,admin', 'Laporan', '/laporan', 'fas fa-info-circle');
        ...
        $this->beginDropdown('user,admin', 'Data Master', 'cil-star');
            $this->insertLink('user,admin', 'Data Akun', '/data-akun', 'fa fa-book nav-icon');
            $this->insertLink('user,admin', 'Data Index', '/data-index', 'fa fa-certificate nav-icon');
            $this->insertLink('user,admin', 'Data Unit', '/data-unit', 'fa fa-bars nav-icon');
            $this->insertLink('user,admin', 'Data Usaha Unit', '/data-usaha-unit', 'fa fa-plus nav-icon');
        $this->endDropdown();
        $this->beginDropdown('user,admin', 'Unit: BPS YPAP', 'nav-icon fas fa-list');
            $this->insertLink('user,admin', 'Jurnal Umum', '/data-akun', 'fa fa-bookmark nav-icon');
            $this->insertLink('user,admin', 'Buku Besar', '/data-index', 'fa fa-book nav-icon');
            $this->insertLink('user,admin', 'Arus Kas', '/data-unit', 'fa fa-angle-double-right nav-icon');
            $this->insertLink('user,admin', 'Laba Rugi', '/data-usaha-unit', 'fa fa-credit-card nav-icon');
            $this->insertLink('user,admin', 'Perubahan Modal', '/data-unit', 'fa fa-low-vision nav-icon');
            $this->insertLink('user,admin', 'Neraca', '/data-usaha-unit', 'fa fa-balance-scale nav-icon');
        $this->endDropdown();
